...
class Map:
    ...
    def __delitem__(self, key: Any) -> None:
        """Remove a (key, value) item from the map."""
...
if __name__ == "__main__":
    ...
    # Add some items
    contacts['Ninja'] = "ninja@email.com"
    ...
    # Check if the item is really deleted. Will show `None`
    print(contacts["John"])
    
    # Iterate the items in alphabetical order of keys
